-- ==========================================
-- DIGITAL SERVICES E-COMMERCE SUPABASE SCHEMA
-- ==========================================
...
CREATE TABLE profiles (
    ...
    email TEXT,
    avatar_url TEXT,
    role TEXT DEFAULT 'retail' CHECK (role IN ('retail', 'wholesale', 'admin')),
    account_status TEXT DEFAULT 'active' CHECK (account_status IN ('active', 'suspended', 'blocked')),
    wholesale_status TEXT DEFAULT 'not_applied' CHECK (wholesale_status IN ('not_applied', 'pending', 'under_review', 'approved', 'rejected', 'suspended')),
